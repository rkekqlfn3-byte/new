...
DEFAULT_MODULE_LINE_BUDGETS = {
    ...
    "engine/edit_mode/controller.py": 1640,
    ...
    # 1541 + 3: a dialog-only operation now speaks its own limit instead of
    # being reported as finished work.
    "engine/edit_mode/stage5.py": 1544,
