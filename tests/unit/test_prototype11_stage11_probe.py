...
from verification import prototype11_stage11_probe as probe


class Prototype11Stage11ProbeSafetyTests(unittest.TestCase):
    ...
    def test_only_full_owned_fixture_pass_claims_success(self):
        ...
        self.assertFalse(report["user_preferences_modified"])
