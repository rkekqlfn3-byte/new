...
handle만 갱신하고 동일 문서 fingerprint를 재확인한 뒤 계속하며, 못 찾으면
문서를 다시 열어 연결하라고 안내합니다. 닫힌 문서를 JARVIS가 대신 열거나 창
focus를 바꾸지는 않습니다.
...
2026-07-18 연결 문서 재탐색 복구 반영 기준으로 전체 자동 테스트
763개 중 760개가 통과했고(unit 260·integration 302·windows 198), 실제 외부
