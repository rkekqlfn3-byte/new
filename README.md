...
2026-07-15 RC5 최종 검증에서 자동 테스트 452개 중 449개가 통과했고 외부 AI
라이브 테스트 3개는 실제 키 사용 승인이 없어 건너뛰었으며 실패는 0개입니다.
기존 Excel/HWP 집중 회귀 55개와 실제 Excel 명령 100회 반복·소유권·예외 종료
검사도 통과했습니다. 사용자 원본을 보호하기 위해 RC5의 HWP 실물 변경 검사는
생략하고 모의 COM 소유권·예외 정리 테스트로 확인했습니다.
