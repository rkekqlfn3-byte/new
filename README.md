...
2026-07-18 UI Automation 실행 전 1회 복구 적용 기준으로 전체 자동 테스트
791개 중 788개가 통과했고(unit 268·integration 317·windows 203), 실제 외부
...
통과했습니다. 10단계 승인형 문서 워크플로, 11단계 명시적 선호 학습과 실제
Word 서식 read-back,
