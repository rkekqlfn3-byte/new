...
검증 완료한 복합 업무는 보고서 형식·PPT 장수와 내용 없는 등록 단계 레시피만 재사용 후보로
...
2026-07-19 다중 집계·선택 범위 워크플로 보강 기준으로 전체 자동 테스트
935개 중 932개가 통과했고(unit 386·integration 343·windows 203), 실제 외부
